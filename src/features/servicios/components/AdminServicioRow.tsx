...
interface AdminServicioRowProps {
  servicio: Servicio;
...
export function AdminServicioRow({
  servicio,
    ...
    >
      ...
      <div className="flex items-center gap-3 sm:gap-4 min-w-0 flex-1">
        ...
        <div className="min-w-0 flex-1">
          <p className="font-serif font-bold text-secondary text-sm sm:text-base truncate">
            {servicio.nombre}
          </p>
          <div className="flex flex-wrap items-center gap-1.5 sm:gap-2 mt-0.5 text-[11px] sm:text-xs font-medium text-primary/60">
            {servicio.precio ? (
